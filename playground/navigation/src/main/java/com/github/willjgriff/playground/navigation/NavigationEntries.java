...
import com.github.willjgriff.playground.sorealm.SoRealmFragment;
...
import static com.github.willjgriff.playground.navigation.NavigationEntries.EntryTag.SOREALM;
...
import static com.github.willjgriff.playground.navigation.NavigationEntries.EntryTag.SIGNUP;
...
public class NavigationEntries {
    ...
    enum EntryTag {
        ...
        SOREALM(R.string.navigation_sorealm, R.integer.navigation_sorealm);
    ...
    public List<NavigationEntry> getNavEntries() {
        ...
        navEntries.add(new NavigationEntry(mContext.getString(SIGNUP.getTitle()), mContext.getResources().getInteger(SIGNUP.getPosition()), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mNavigationListener.onEntryClicked(new SignupFragment(), SIGNUP);
            }
        }));
        navEntries.add(new NavigationEntry(mContext.getString(SOREALM.getTitle()), mContext.getResources().getInteger(SOREALM.getPosition()), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mNavigationListener.onEntryClicked(new SoRealmFragment(), SOREALM);
            }
        }));
