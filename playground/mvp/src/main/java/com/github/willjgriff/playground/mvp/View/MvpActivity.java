 ...
 */
public abstract class MvpActivity<PRESENTER extends MvpPresenter> extends AppCompatActivity implements MvpView {
    ...
    /**
     * I may add a call to the presenter here if
     */
    @Override
